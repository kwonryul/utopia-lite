(ns user
  ...
  (:require
    ...
    [papercompany.utopia-lite.core :refer [start-app]]))
...
(defn dev-prep!
  ...
  (integrant.repl/set-prep! (fn []
                              (-> (papercompany.utopia-lite.config/system-config {:profile :dev})
                                  (ig/prep)))))

(defn test-prep!
  []
  (integrant.repl/set-prep! (fn []
                              (-> (papercompany.utopia-lite.config/system-config {:profile :test})
                                  (ig/prep)))))
